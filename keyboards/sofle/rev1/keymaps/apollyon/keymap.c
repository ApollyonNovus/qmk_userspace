...
[_NAV] = LAYOUT(
      ...
      //|------+-------+--------+--------+--------+------|  ===  |                        |  ===  |--------+-------+--------+--------+--------+---------|
                     TO(KC_GAME1), _______, _______, _______, _______,                          _______, _______, _______, _______, _______
      //            \--------+--------+--------+---------+-------|                        |--------+---------+--------+---------+-------/
),
...
[_GAME1] = LAYOUT(
      ...
      //|-------+--------+--------+--------+--------+--------|  ====  |                   |  ====  |--------+-------+--------+--------+--------+--------|
                    _______, KC_GRV, LT(KC_GAME2),KC_LCTRL, KC_SPC,                               _______, _______, _______, _______, _______
      //            \--------+--------+--------+---------+-------|                             |--------+--------+--------+--------+-------/
),
...
[_GAME2] = LAYOUT(
      ...
      //|-------+--------+--------+--------+--------+--------|  ====  |                   |  ====  |--------+-------+--------+--------+--------+--------|
                   TO(KC_BASE), _______, _______, _______, _______,                               _______, _______, _______, _______, _______
      //            \--------+--------+--------+---------+-------|                             |--------+--------+--------+--------+-------/
),
