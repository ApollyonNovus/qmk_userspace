...
[_BASE] = LAYOUT(
      ...
      //|------+-------+--------+--------+--------+------|                                        |--------+-------+--------+--------+--------+---------|
  LT(_NUMPAD,KC_TAB),KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                                        KC_Y,    KC_U,   KC_I,    KC_O,    KC_P,    KC_MINUS,
      //|------+-------+--------+--------+--------+------|                                        |--------+-------+--------+--------+--------+---------|
      KC_LCTL,       KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                                        KC_H,    KC_J,   KC_K,    KC_L,    KC_SCLN, KC_QUOT,
      //|------+-------+--------+--------+--------+------|  ===  |                        |  ===  |--------+-------+--------+--------+--------+---------|
      KC_LSFT,       KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  C(A(KC_DEL)),               XXXXXXX,  KC_N,    KC_M,   KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
      //|------+-------+--------+--------+--------+------|  ===  |                        |  ===  |--------+-------+--------+--------+--------+---------|
            KC_BSPC, KC_GRAVE, LGUI_T(KC_APP), LT(_NAV, KC_ENT), ALT_T(KC_SPC),             KC_SPC,  LT(_NAV, KC_ENT), RGUI_T(KC_APP), KC_MINUS, KC_DEL
  //                \--------+--------+--------+---------+-------|                        |--------+---------+--------+---------+-------/
),
...
[_NAV] = LAYOUT(
      ...
      //|------+-------+--------+--------+--------+------|  ===  |                        |  ===  |--------+-------+--------+--------+--------+---------|
                     TO(_GAME1), _______, _______, _______, _______,                          _______, _______, _______, _______, _______
      //            \--------+--------+--------+---------+-------|                        |--------+---------+--------+---------+-------/
),
...
[_GAME1] = LAYOUT(
      ...
      //|-------+--------+--------+--------+--------+--------|  ====  |                   |  ====  |--------+-------+--------+--------+--------+--------|
                     _______, KC_GRV, LT(_GAME2),KC_LCTRL, KC_SPC,                               _______, _______, _______, _______, _______
      //            \--------+--------+--------+---------+-------|                             |--------+--------+--------+--------+-------/
),
...
[_GAME2] = LAYOUT(
      ...
      //|-------+--------+--------+--------+--------+--------|  ====  |                   |  ====  |--------+-------+--------+--------+--------+--------|
                    TO(_BASE), _______, _______, _______, _______,                               _______, _______, _______, _______, _______
      //            \--------+--------+--------+---------+-------|                             |--------+--------+--------+--------+-------/
),
